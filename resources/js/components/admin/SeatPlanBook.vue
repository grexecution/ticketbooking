    ...
    methods: {
        ...
        proceedToCheckout() {
            ...
            if (! this.first_name.trim()) {
                this.errorMsg = 'Firstname is empty';
                return;
            }
            if (! this.last_name.trim()) {
                this.errorMsg = 'Lastname is empty';
                return;
            }
        ...
        async bookTickets(tickets, total) {
            try {
                const response = await axios.post(`/events/book/${this.eventId}`, {
                    id: this.eventId,
                    tickets_data: {
                        tickets: tickets,
                        amount: total
                ...
                if (response.status === 200) {
                    ...
                    window.location.href = `/admin/orders/${response.data.order.id}`;
                } else {
            ...
            <div class="selected-seats">
                ...
                <div v-if="selectedSeats.length > 0">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="first_name" v-model="first_name" placeholder="Vorname" required>
                    </div>
                    <div class="form-group">
                        <label for="lastName">Nachname</label>
                        <input type="text" class="form-control" name="last_name" v-model="last_name" placeholder="Nachname" required>
                    </div>
                    <div class="form-group">
                        <label for="address">Adresse</label>
                        <input type="text" class="form-control" name="address" v-model="address" placeholder="Adresse">
                    </div>
                    <div class="form-group">
                        <label for="zip_code">Postleitzahl</label>
                        <input type="text" class="form-control" name="zip_code" v-model="zip_code" placeholder="Postleitzahl">
                    </div>
                    <div class="form-group">
                        <label for="city">Stadt</label>
                        <input type="text" class="form-control" name="city" v-model="city" placeholder="Stadt">
                    </div>
                    <div class="form-group">
                        <label for="email">E-mail Adresse</label>
                        <input type="email" class="form-control" name="email" v-model="email" placeholder="E-mail Adresse">
                    </div>
                    <div class="form-group">
                        <label for="phone">Telefon</label>
                        <input type="text" class="form-control" name="phone" v-model="phone" placeholder="Telefon">
                    </div>
                </div>
