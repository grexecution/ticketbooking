                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input v-model="seatType" class="form-check-input" type="radio" name="seat_type" id="seat_plan" value="seat_plan" checked>
                            <label class="form-check-label" for="seatplan">
                                Seatplan Selection
                            </label>
                        </div>
                        <div class="form-check">
                            <input v-model="seatType" class="form-check-input" type="radio" name="seat_type" id="no_seat_plan" value="no_seat_plan">
            ...
            <div v-if="seatType === 'no_seat_plan'" class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input v-model="seatAmount" type="number" step="1" min="0" class="form-control" :id="seatAmount" name="seat_amount" placeholder="0" />
                    </div>
                </div>
